...
// Replace all instances of , '''', with , 'UUID', where UUID is random.
// But we should only do this for the specific insert statements.
const tables = ['categories', 'locations', 'suppliers', 'units', 'items'];
