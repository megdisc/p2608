...
-- Skill Levels
INSERT INTO skill_levels (id, level_value, name, description) VALUES ('e24bd35c-7833-41c3-ab5b-5136db6d75d1', 1, '初級', '基本的な作業はできるが、サポートが必要');
INSERT INTO skill_levels (id, level_value, name, description) VALUES ('cdfc7a4d-c124-41d3-98cb-fb1b15ad39bb', 2, '中級', '日常的な作業を自立して行える');
INSERT INTO skill_levels (id, level_value, name, description) VALUES ('9b139db0-a352-4f38-89c0-9dff60a4f66a', 3, '上級', '他者のサポートやトラブルシューティングができる');
