...
('11111111-0000-0000-0000-000000000001', 'type_b', '就労継続支援B型', '就労機会の提供および生産活動の機会の提供を行う障害福祉サービス', true),
('11111111-0000-0000-0000-000000000002', 'type_a', '就労継続支援A型', '雇用契約に基づく就労の機会の提供および知識能力向上のための訓練を行う障害福祉サービス', false),
('11111111-0000-0000-0000-000000000003', 'transition', '就労移行支援', '一般企業等への就労を希望する障害者に対する就労支援および知識能力向上支援サービス', false),
('11111111-0000-0000-0000-000000000004', 'ikou_teichaku', '就労定着支援', '一般就労へ移行した障害者の就労継続および日常生活・社会生活の定着支援サービス', false),
('11111111-0000-0000-0000-000000000005', 'seikatsu_kaigo', '生活介護', '常時介護を要する障害者に対する入浴・排せつ・食事等の介護および創作的活動の機会提供サービス', false),
('11111111-0000-0000-0000-000000000006', 'jiritsu_kunren_seikatsu', '自立訓練（生活訓練）', '自立した日常生活または社会生活を営むことができるよう行う訓練および生活支援サービス', false),
('11111111-0000-0000-0000-000000000007', 'jiritsu_kunren_kinou', '自立訓練（機能訓練）', '身体的機能の維持・向上のために行う訓練および支援サービス', false),
('11111111-0000-0000-0000-000000000008', 'kyodo_seikatsu', '共同生活援助（グループホーム）', '地域で共同生活を営む障害者に対する相談・日常生活上の援助および介護支援サービス', false),
('11111111-0000-0000-0000-000000000009', 'shisetsu_nyusho', '施設入所支援', '施設に入所する障害者に対する夜間や休日における入浴・排せつ・食事等の介護支援サービス', false),
('11111111-0000-0000-0000-000000000010', 'kyotaku_kaigo', '居宅介護（ホームヘルプ）', '自宅での入浴・排せつ・食事等の介護や家事援助サービス', false),
('11111111-0000-0000-0000-000000000011', 'judo_homon', '重度訪問介護', '重度の肢体不自由者等に対する総合的な訪問介護支援サービス', false),
('11111111-0000-0000-0000-000000000012', 'doko_engo', '同行援護', '視覚障害者に対する移動時や外出先での視覚的情報の支援および移動介護サービス', false),
('11111111-0000-0000-0000-000000000013', 'kodo_engo', '行動援護', '知的・精神障害により行動上著しい困難がある障害者に対する外出時等の危険回避・行動支援サービス', false),
('11111111-0000-0000-0000-000000000014', 'judo_hokatsu', '重度障害者等包括支援', '常時介護を要する重度障害者に対する包括的な各種サービスの提供', false),
('11111111-0000-0000-0000-000000000015', 'tanki_nyusho', '短期入所（ショートステイ）', '介護者の病気等の理由により短期間施設に入所して生活支援を受けるサービス', false),
('11111111-0000-0000-0000-000000000016', 'ryoyo_kaigo', '療養介護', '病院等で行う医療と常時介護の組み合わせによる支援サービス', false),
('11111111-0000-0000-0000-000000000017', 'jiritsu_seikatsu', '自立生活援助', '施設・病院から退所・退院した障害者に対する一人暮らしに向けた定期訪問・相談支援サービス', false),
('11111111-0000-0000-0000-000000000018', 'keikaku_sodan', '計画相談支援', 'サービス利用計画の作成・モニタリングおよび総合的な相談支援', false),
('11111111-0000-0000-0000-000000000019', 'chiiki_iko', '地域移行支援', '施設入所者や精神科病院入院者に対する地域生活への移行に向けた相談・支援サービス', false),
('11111111-0000-0000-0000-000000000020', 'chiiki_teichaku', '地域定着支援', '単身等で生活する障害者に対し常時連絡体制を確保し緊急時の相談・訪問支援を行うサービス', false),
('11111111-0000-0000-0000-000000000021', 'jido_hattatsu', '児童発達支援', '未就学の障害児に対する日常生活における基本動作の指導・訓練支援サービス', false),
('11111111-0000-0000-0000-000000000022', 'hokago_day', '放課後等デイサービス', '就学中の障害児に対する授業終了後や休業日における生活能力向上訓練・居場所提供サービス', false),
('11111111-0000-0000-0000-000000000023', 'kyotaku_jido', '居宅訪問型児童発達支援', '重度の障害等により外出が困難な障害児の居宅を訪問して行う発達支援サービス', false),
('11111111-0000-0000-0000-000000000024', 'hoikusho_homon', '保育所等訪問支援', '保育所等を訪問し障害児に対する集団生活適応のための専門的支援を行うサービス', false),
('11111111-0000-0000-0000-000000000025', 'jido_center', '児童発達支援センター', '地域における障害児支援の中核的機関としての総合的な発達支援および地域支援サービス', false),
('11111111-0000-0000-0000-000000000026', 'fukushi_nyusho', '障害児入所施設（福祉型）', '障害児を入所させて保護、日常生活の指導および独立自活に必要な知識技能の付与を行う施設', false),
('11111111-0000-0000-0000-000000000027', 'iryo_nyusho', '障害児入所施設（医療型）', '障害児に入所保護および医療的ケア・リハビリテーションを行う施設', false),
('11111111-0000-0000-0000-000000000028', 'shogaiji_sodan', '障害児相談支援', '障害児支援利用計画の作成・モニタリングおよび相談支援サービス', false)
ON CONFLICT (id) DO NOTHING;
...
('22222222-0000-0000-0000-000000000001', 'QUAL-001', 'サービス管理責任者（サビ管）', '人員配置・必置資格', '個別支援計画の作成・評価・技術指導等を行う障害福祉事業所の必置人員資格', true),
('22222222-0000-0000-0000-000000000002', 'QUAL-002', '児童発達支援管理責任者（児発管）', '人員配置・必置資格', '障害児通所支援等において個別支援計画の作成・評価を行う必置人員資格', false),
('22222222-0000-0000-0000-000000000003', 'QUAL-003', '社会福祉士', '国家資格・配置加算要件', '相談援助の専門的知識を有し、専門職配置加算等の要件となる国家資格', true),
('22222222-0000-0000-0000-000000000004', 'QUAL-004', '精神保健福祉士', '国家資格・配置加算要件', '精神保健福祉分野の相談援助の専門的知識を有し、専門職配置加算等の要件となる国家資格', true),
('22222222-0000-0000-0000-000000000005', 'QUAL-005', '介護福祉士', '国家資格・処遇改善要件', '介護の専門的技術を有し、処遇改善加算や福祉・介護職員等専門職配置加算の対象資格', true),
('22222222-0000-0000-0000-000000000006', 'QUAL-006', '公認心理師', '国家資格・配置加算要件', '心理臨床支援の専門的知識を有し、心理支援加算等の対象となる国家資格', false),
('22222222-0000-0000-0000-000000000007', 'QUAL-007', '看護師・准看護師', '医療資格・看護配置加算', '医療的ケアや健康管理を行う医療資格。看護職員配置加算や医療的ケア児支援加算の要件', false),
('22222222-0000-0000-0000-000000000008', 'QUAL-008', '理学療法士（PT）', 'リハビリ専門資格', '身体的機能の回復・維持のためのリハビリテーション支援を行う医療専門資格', false),
('22222222-0000-0000-0000-000000000009', 'QUAL-009', '作業療法士（OT）', 'リハビリ専門資格', '作業行動を通じた精神・身体機能の維持回復支援を行う医療専門資格', false),
('22222222-0000-0000-0000-000000000010', 'QUAL-010', '言語聴覚士（ST）', 'リハビリ専門資格', '言語・コミュニケーション機能や摂食嚥下機能の訓練支援を行う医療専門資格', false),
('22222222-0000-0000-0000-000000000011', 'QUAL-011', '目標工賃達成指導員', '就労支援・配置加算要件', '就労継続支援B型等において工賃向上に向け作業指導・販路拡大を行う人員資格', true),
('22222222-0000-0000-0000-000000000012', 'QUAL-012', '職業指導員', '基準配置資格', '就労支援事業所において作業技術の指導・生産活動の支援を行う人員資格', true),
('22222222-0000-0000-0000-000000000013', 'QUAL-013', '生活支援員', '基準配置資格', '障害福祉サービス事業所において日常生活の支援・相談対応を行う人員資格', true),
('22222222-0000-0000-0000-000000000014', 'QUAL-014', '強度行動障害支援者養成研修修了者', '専門研修修了資格', '強度行動障害を有する障害者への適切な支援および各種行動障害加算の要件資格', false),
('22222222-0000-0000-0000-000000000015', 'QUAL-015', '相談支援専門員', '相談支援必置資格', '障害福祉サービスの利用計画作成や総合的な相談援助を行う事業所の必置人員資格', false),
('22222222-0000-0000-0000-000000000016', 'QUAL-016', '保育士', '児童福祉専門資格', '障害児通所支援・入所施設等において児童の指導・発達支援を行う専門資格', false),
('22222222-0000-0000-0000-000000000017', 'QUAL-017', '児童指導員', '児童福祉基準配置資格', '障害児施設等において児童の健全育成や指導を行う基準配置資格', false),
('22222222-0000-0000-0000-000000000018', 'QUAL-018', '訪問介護員（ヘルパー2級・初任者研修）', '介護基礎資格', '居宅介護や重度訪問介護等の訪問系サービスにおいて介護業務を行う基礎資格', false),
('22222222-0000-0000-0000-000000000019', 'QUAL-019', '実務者研修修了者', '介護中堅資格', 'より高度な介護知識・技能を有し介護福祉士受験要件ともなる研修修了資格', false),
('22222222-0000-0000-0000-000000000020', 'QUAL-020', '同行援護従業者養成研修修了者', '専門訪問支援資格', '視覚障害者の移動支援・外出支援を行う同行援護事業の従事要件資格', false),
('22222222-0000-0000-0000-000000000021', 'QUAL-021', '行動援護従業者養成研修修了者', '専門訪問支援資格', '知的・精神障害により行動上著しい困難がある障害者の行動支援を行う従事要件資格', false),
('22222222-0000-0000-0000-000000000022', 'QUAL-022', '喀痰吸引等研修修了者（医療的ケア）', '医療的ケア研修資格', '介護職員等が一定の医療的ケア（たんの吸引・経管栄養）を実施するための研修修了資格', false),
('22222222-0000-0000-0000-000000000023', 'QUAL-023', '就労定着支援員', '就労支援専門資格', '一般就労へ移行した障害者の職場定着や生活面の定着支援を行う専門要件資格', false),
